...
const Home: Component = () => {
    return (
        <Layout class="space-y-10">
            <section id="home" class="flex items-center justify-between space-x-6 py-12">
                ...
                <img src="/images/profile.jpg" alt="Profile" class="size-[500px] rounded-xl" />
            </section>
                        ...
                        {(project) => (
                            <div
                                class={`flex justify-between gap-6 rounded-xl border p-4 ${
                                    project.isFullWidth ? 'w-full' : 'w-[calc(50%-12px)] flex-col'
                                }`}
                            >
                                <div class={`flex flex-col space-y-4 ${project.isFullWidth ? 'w-1/2' : 'w-full'}`}>
                                ...
                                <img
                                    src={project.image}
                                    alt={project.title}
                                    class={`h-64 w-full rounded object-cover ${project.isFullWidth ? 'w-1/2' : 'w-full'}`}
                                />
                            </div>
                        )}
                    </For>
            ...
            <section id="contact" class="flex flex-col space-y-8 pb-20 pt-4">
                ...
                <div class="flex flex-col space-y-12">
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        <img src="/images/profile.jpg" alt="Profile" class="size-[400px] rounded-full" />
